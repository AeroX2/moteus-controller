/**
  ******************************************************************************
  * @file      startup_stm32g431xx_openblt.s
  * @author    MCD Application Team (STM32 template); OpenBLT row added for this project.
  * @note      Included by Arduino core startup_stm32yyxx.S; file is in project root
  *            and referenced from platformio.ini build flags (kept out of src/).
...
g_pfnVectors:
	...
	.word	0x55AA11EE	/* OpenBLT: checksum placeholder at vector offset 0x1D8 */
